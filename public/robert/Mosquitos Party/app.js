...
class Example extends Phaser.Scene {
  ...
  preload() {      
    ...
    this.load.audio('mosquito', ['https://cdn.glitch.global/e73a15d2-2f8a-477d-80bc-a6e8167fe97a/mosquito-22808.mp3?v=1703709898648']);
  ...
  update() {
    ...
    this.mosquitos.forEach( (mosquito)=> {
      mosquito.x += Phaser.Math.Between(-5,5) + Math.cos(this.angle) * this.speed
      mosquito.y += Phaser.Math.Between(-5,5) + Math.sin(this.angle) * this.speed
  ...
  gameOver() {
    ...
    this.add.text(100, 300, this.nbMosquitos+' mosquitos 💥', { fontSize: '24px', fill: '#fff' });
...
const config = {
    ...
    scale: {
        ...
        width: "100%", // hack for android 7 moto g5
       height: "100%", // allow rotating works nicely
    },
};
// 2) Lancement du Jeu 💫🤩🚀 !
