...
syncImport("https://unpkg.com/ammo.js@0.0.10/ammo.js", main);
import "https://code.playcanvas.com/playcanvas-stable.min.js";

clear();
print("<center>🚗<h1><purple>playcanvas loading...</h1>");
...
function main() {
  clear();
  print("<center>👀<h1><orange>playcanvas<br><blue>click to reset");
  ...
  // Mise à jour et mouvement des spheres
  x.onUpdate((dt) => {});
  ...
  function generateSpheres() {
    for (let i = 0; i < numSpheres; i++) {
      let pos = x.position(
        ...
        20 + Math.random() * worldSize - worldSize / 2,
        Math.random() * worldSize - worldSize / 2
      );
...
class X3d {
  constructor() {
    ...
    print(
      '<canvas id="application" style="width:100vw; height:100vh"></canvas>'
    );
