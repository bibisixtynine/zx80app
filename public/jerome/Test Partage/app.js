...
Qwark
---
<button id="shareButton">click me</button>
</h1>
...
function buttonClicked() {
    ...
    navigator.share({
      ...
      text: 'Salut ! Click sur le lien pour jouer avec ma nouvelle webApp !',
      //url: window.location.href
      url: "https://qwark.glitch.me/jerome/Space Invaders"
    }).then(() => {
    ...
    // Gérer le cas où l'API Web Share n'est pas disponible
  }
}
